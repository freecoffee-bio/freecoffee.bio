...
export const creatorPageSettings = sqliteTable('creator_page_settings', {
  ...
  minimumSupportAmount: integer('minimum_support_amount').notNull().default(100),
  supportWording: text('support_wording').notNull().default('donate'),
  supportThankYouMessage: text('support_thank_you_message'),
